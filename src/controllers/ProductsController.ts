  ...
  create(request: Request, response: Response) {
    const bodySchema = z.object({
      name: z
        ...
        .trim()
        .min(6, { message: "Name must be 6 or more characters" }), // Customizando a mensagem de erro com a propriedade required_error
      price: z.number().positive({ message: "Price must be positive" }), //nullish serve para deixar de ser obrigatório o dado. dizer que pode ser nulo ou undefined.
    });
